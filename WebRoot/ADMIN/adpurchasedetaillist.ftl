		...
		(
			function()
			{
				$.blockUI({ message: "正在加载..." });
				 ...
				 $.post("doPurchaseDetailList.action",{id:$("#id").val()}, function(data) {
					...
					$.each(jsondata,function(index)
					{
						...
						var _td_tr="</td></tr>";
						var str=trtd+obj.id+_tdtd+obj.goods+_tdtd+obj.quantity+_tdtd+obj.cost+_td_tr
	      ...
	      <tr>
	        <td>
	          <table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#FFFFFF">
	            <tr>
	              <td class="font1">&nbsp;<a href="#">采购管理</a> &gt; <a href="purchaseList.action">采购记录</a> &gt; <a href="#">采购明细</a></td>
	            </tr>
	          </table>
	        </td>
	      </tr>
